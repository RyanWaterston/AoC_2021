def check_adj(row, col):
    if row < ROW_SIZE and col < COL_SIZE and \
       row >= 0 and col >= 0 and flash_map[row][col] == 0:
...
with open("/home/rwr/advent/day11/input.txt", "r") as input_file:
    ...
    energy_levels = [[int(o) for o in line.strip()] for line in lines]
